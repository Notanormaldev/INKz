...
This document contains the step-by-step technical instructions for running INKz locally on your machine, setting up 100% offline local AI (Ollama) or custom cloud LLMs, and configuring Kubernetes pod microservices with Skaffold.
